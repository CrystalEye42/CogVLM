...
MODEL_ARGS="--from_pretrained /scratch/wang7776/test_finetune/checkpoints/test_rxnscribe_mol_only_2-07-22-14-51/merged_lora_cogagent \
    --max_length 2048 \
...
gpt_options=" \
       --experiment-name rxnscribe_mol_only_2_eval \
